---
{"dg-publish":true,"dg-path":"03_Literature_notes/_literature_notes_workflow","permalink":"/03_Literature_notes/_literature_notes_workflow/","title":"Literature notes - workflow","tags":["obsidian","index","workflow"],"created":"2025-12-05T03:27:50.259+01:00"}
---
...
> By following the same structure and workflow i have described in [[_workflow\|workflow index note]] it will be easier to find the notes that requires your attention. Notes with `status:draft` or `status:useful` will be displayed as a `Dataview` query inside [[_dataview_database/index\|dataview index note]] or you can use a regular obsidian search and define the parameters you want to return. Metadata properties are very important feature if you plan to expand your note vault.

## Read more

- [[_templates/spiritual_literature_template\|spiritual_literature_template]] - template for spiritual and religious notes
- [[05_Archive/reading books\|How to read books]] - personal note
