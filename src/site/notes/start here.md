---
{"dg-publish":true,"dg-path":"index","permalink":"/index/","title":"Start here","tags":["personal","index","writings","gardenEntry"],"created":"2025-12-05T03:27:50.258+01:00"}
---
...
- [[start here\|current file]]
- [[README\|README.md]]
- [[_workflow\|workflow rules]]
- [[_dataview_database/index\|Dataview index]] - Use this index to find the prioritised notes

##### Footnotes

[^1]: The "Second Brain" is a methodological framework for capturing, organizing, and retrieving everything you learn and create, essentially moving mental effort out of your head and into a trusted external digital system. The system utilising Obsidian is based on interconnected files (like a wiki or a knowledge graph) rather than rigid, hierarchical directories.
